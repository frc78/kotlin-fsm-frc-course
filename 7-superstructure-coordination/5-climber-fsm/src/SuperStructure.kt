...
// The superstructure FSM from tasks 2 and 3, complete. It reads OI and
// Intake.state. It never touches the intake or the climber.
object SuperStructure : Subsystem {
    ...
    // The sequencing rule from task 3: going down, elevator first with the arm
    // at the safe angle; otherwise arm first, then elevator.
