...
sourceSets {
    main {
        kotlin.srcDirs(
            ...
            // Lesson 6
            "6-swerve-requests/1-field-and-robot-centric/src",
            "6-swerve-requests/2-brake-and-point-wheels/src",
            "6-swerve-requests/3-facing-angle/src",
            "6-swerve-requests/4-joystick-mapping/src",
            "6-swerve-requests/5-drive-mode-fsm/src",
            // Lesson 7
            "7-superstructure-coordination/1-pose-enum/src",
            "7-superstructure-coordination/2-superstructure-fsm/src",
            "7-superstructure-coordination/3-sequencing-rule/src",
            "7-superstructure-coordination/4-intake-fsm/src",
            "7-superstructure-coordination/5-climber-fsm/src",
            "7-superstructure-coordination/6-robot-loop/src",
            // Lesson 8
    ...
    test {
        kotlin.srcDirs(
            ...
            "6-swerve-requests/1-field-and-robot-centric/test",
            "6-swerve-requests/2-brake-and-point-wheels/test",
            "6-swerve-requests/3-facing-angle/test",
            "6-swerve-requests/4-joystick-mapping/test",
            "6-swerve-requests/5-drive-mode-fsm/test",
            "7-superstructure-coordination/1-pose-enum/test",
            "7-superstructure-coordination/2-superstructure-fsm/test",
            "7-superstructure-coordination/3-sequencing-rule/test",
            "7-superstructure-coordination/4-intake-fsm/test",
            "7-superstructure-coordination/5-climber-fsm/test",
            "7-superstructure-coordination/6-robot-loop/test",
