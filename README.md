...
7. **Coordinating subsystems** — peer state machines (superstructure, intake, climber) that read each other's state, a pose enum, a sequencing rule, and the robot loop.
